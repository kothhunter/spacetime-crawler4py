...
- tokenize(): O(n); n = number of characters
- compute_word_frequencies(): O(m); m = number of tokens
- print_frequencies(): O(k log k); k = number of unique tokens (due to sorting)
"""
