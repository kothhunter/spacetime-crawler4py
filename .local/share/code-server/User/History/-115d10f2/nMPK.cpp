...
TEST(StringFunction, strstr) {
    const char *haystack = "boocar";
    EXPECT_EQ(String::strstr(haystack, "boo"), haystack);
    EXPECT_EQ(String::strstr(haystack, "car"), haystack + 3);
    EXPECT_EQ(String::strstr(haystack, "oca"), haystack + 2); 
