...
TEST(StringFunction, strncmp) {
    EXPECT_EQ(String::strncmp("", "", 1), 0); // Compare empty strings
    EXPECT_EQ(String::strncmp("foo", "foo", 3), 0); // Compare equal strings
    EXPECT_EQ(String::strncmp("foo", "foobar", 3), 0); // Compare first 3 characters
    EXPECT_LT(String::strncmp("apple", "banana", 5), 0); // Compare first 5 characters
    EXPECT_GT(String::strncmp("banana", "apple", 5), 0); // Compare first 5 characters
    EXPECT_EQ(String::strncmp("foo", "bar", 0), 0); // Compare 0 characters
}
