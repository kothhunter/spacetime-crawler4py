...
//     EXPECT_EQ(String::strchr("boocar", "boo"), "boocar");
//     EXPECT_EQ(String::strchr("boocar", "car"), "car"); 
//     EXPECT_EQ(String::strchr("boocar", "oca"), "ocar");
//     EXPECT_EQ(String::strchr("boocar", "xyz"), nullptr); 
//     EXPECT_EQ(String::strchr("", "boo"), nullptr); 
// }
