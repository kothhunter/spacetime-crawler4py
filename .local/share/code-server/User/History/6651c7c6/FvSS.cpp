...
Coins Coins::extract_exact_change(const Coins& coins){
    ...
    return extraction ? extracted : Coins(0, 0, 0, 0);
}
...
Coins coins_required_for_cents(int amt_in_cents) {
    int q = amt_in_cents / CENTS_PER_QUARTER;
    amt_in_cents %= CENTS_PER_QUARTER;
    int d = amt_in_cents / CENTS_PER_DIME;
    amt_in_cents %= CENTS_PER_DIME;
    int n = amt_in_cents / CENTS_PER_NICKEL;
    amt_in_cents %= CENTS_PER_NICKEL;
    int p = amt_in_cents;
