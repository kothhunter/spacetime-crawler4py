...
TEST(WordCount, CountWords) {
    istringstream first_input("a A aa Aaa");
    set<string> stopwords0 = {};
    map<string, int> expect0 = {{"a",2},{"aa",1},{"aaa",1}};
    EXPECT_EQ(expect0, count_words(first_input, stopwords0));

    istringstream second_input("This this is IS a test");
    set<string> stopwords1 = {"this","is"};
    map<string, int> expect1 = {{"a",1},{"test",1}};
    EXPECT_EQ(expect1, count_words(second_input,stopwords1));

    istringstream third_input("THIS IS A TEST");
    set<string> stopwords2 = {"this", "is", "a", "test"};
