...
TEST(StudentValidateTest, ValidScores) {
    Student s;
    s.quiz = {90, 80, 70};
    s.hw = {85, 95, 100};
    s.final_score = 88;
...
TEST(StudentValidateTest, InvalidQuizScore) {
    Student s;
...
TEST(StudentValidateTest, InvalidHwScore) {
    Student s;
    s.quiz = {90, 80, 70};
...
TEST(StudentValidateTest, InvalidFinalScore) {
    Student s;
    s.quiz = {90, 80, 70};
    s.hw = {85, 95, 100};
...
TEST(StudentValidateTest, MultipleInvalidScores) {
    Student s;
